...
public class FSM<T> {
    ...
    /**
     * Initialise a new FSM. Note that client code must invoke start() on the
     * FSM before any other methods.
     *
    ...
    /**
     * Invalidate the FSM by leaving the current state without entering a new
     * one.
     */
    public void stop() {
        state.exit();
